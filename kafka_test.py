...
# {"count":4,"device":"1729414e-1d7f-4e1f-b8bb-e4b0b1009648","termId":2,"timeCourse":"2019-10-09 17:55:00"} {"count":3,"device":"60ab3ce1-6904-46c3-a8d8-894d90d6cb77","termId":4,"timeCourse":"2019-10-09 17:55:00"}
count = 0
for msg in balanced_consumer:
    try:
        ...
        tm = data.get('timeCourse', '')
        count = data.get('count', '')
        print(",".join(list(map(str, [device, termid, tm, count]))), file=outf)
